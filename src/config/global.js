  ...
  complementario: [
    {
      ...
      referencia:
        'Ecosistema de Recursos Educativos Digitales SENA. (2023). Conservación de forrajes. (video). YouTube.',
      tipo: 'Video',
      link:
    ...
    },
    {
      ...
      referencia:
        'TvAgro. (2023). Manejo y conservación de forrajes - TvAgro por Juan Gonzalo Angel Restrepo. (video). YouTube.',
      tipo: 'Video',
    ...
    },
    {
      tema: 'Heno',
      referencia:
        'TvAgro. (2023). Produccion de Heno Excelente Alternativa Nutricional - TvAgro por Juan Gonzalo Angel Restrepo. (video). YouTube.',
      tipo: 'Video',
    ...
    },
    {
      tema: 'Suplementación',
      referencia:
        'La Finca de Hoy. (2019). Suplemento económico para bovinos - La Finca de Hoy. (video). YouTube.',
      tipo: 'Video',
    ...
    },
    {
      ...
      referencia:
        'La Finca de Hoy. (2019). Ensilajes vs suplementos proteicos. (video). YouTube.',
      tipo: 'Video',
    ...
    },
    {
      ...
      referencia:
        'La Finca de Hoy. (2017). Alternativas en la suplementación de bovinos | La Finca de Hoy (video). YouTube.',
      tipo: 'Video',
